...
VertexNODE* Graph::getRoot()
{
    return this->root;
}


void Graph::InsertVertex(char name, DraggableLabel* visualNode)
{
...
VertexNODE * Graph::searchVertex(char name)
{
    VertexNODE * current = root;
...
void Graph::InsertEdge(char VertexName, char EdgeName, int weight/* = 1*/)
{
...
void Graph::InsertEdgeDirected(char VertexName, char EdgeName, int weight/* = 1*/)
{
    EdgeNODE *temp = new EdgeNODE();
...
void Graph::InsertEdge(char VertexName, EdgeNODE* myEdge)
{
    VertexNODE *Vertex = searchVertex(VertexName);
...
void Graph::Delete(char VertexName, char Edge)
{
...
EdgeNODE* Graph::Isconnected(char Vertex1, char Vertex2)
{
...
string Graph::Path(char Source, char Destination, VertexNODE* delimiter/* = NULL*/)
{
    string path;
...
string Graph::Cycle(char Vertex)
{
    string path;
...
string Graph::DjikstraShortestPath(char Source, char Destination)
{
    VertexNODE* SourceVertex = searchVertex(Source);
    VertexNODE* DestinationVertex = searchVertex(Destination);
...
EdgeNODE* Graph::LeastWeightEdge()
{
...
void Graph::SortEdgesByWeight(char Vertex)
{
